      ...
      test("View issues on a project: GET request to /api/issues/{project}", function (done) {
        chai
          ...
          .end(function (err, res) {
            ...
            // Prueba de que al menos hay 4 issues en la base de datos
        ...
        chai
          ...
          .end(function (err, res) {
            ...
            assert.deepEqual(res.body[0], {
              ...
              issue_title: "Issue",
              issue_text: "Functional Test",
              created_on: "2024-02-27T04:51:12.898Z",
              updated_on: "2024-02-27T04:51:12.898Z",
              created_by: "fCC",
              assigned_to: "",
              open: true,
              status_text: "",
    ...
    suite("5 Put request Tests", function () {
      test("Update one field on an issue: PUT request to /api/issues/test-data-put", function (done) {
        chai
          ...
          .send({
            _id: "65dd6aeaa23f8b7794a53e5a",
            issue_title: "different",
          })
          .end(function (err, res) {
            assert.equal(res.status, 200);
            assert.equal(res.body.result, "successfully updated");
            assert.equal(res.body._id, "65dd6aeaa23f8b7794a53e5a");
      ...
      test("Update multiple fields on an issue: PUT request to /api/issues/{project}", function (done) {
        chai
          ...
          .end(function (err, res) {
            assert.equal(res.status, 200);
            assert.equal(res.body.result, "successfully updated");
            assert.equal(res.body._id, "65dd6b6de84c7a77549d3f5c");
